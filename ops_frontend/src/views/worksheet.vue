      ...
      <div>
        <div class="container">
          ...
          <el-table :data="ticketsTableData" border stripe table-layout='auto' ref="multipleTable" header-cell-class-name="table-header">
            ...
            <el-table-column prop="display_values" label="详细内容" width="500px">
<!--              <template #default="scope">-->
...
import {getCusWorkflowList, getTickets, ticketsDetail, deleteTickets, getCurrentFields, getInitialTicketRelatedUrls, getEditTicketRelatedUrls} from '../api/cusWorkflow';
...
const isSuper = userPermission.user.is_superuser;
...
const getTicketsList = (workflowId?: any, pageSize?: any, pageNum?: any, name?:string, isCompleted?: any) => {
  getTickets(workflowId, pageSize, pageNum, name, isCompleted).then((res)=>{
